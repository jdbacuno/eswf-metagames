...
const renderNavbar = (data) => {
  ...
  navbar.innerHTML = `
        <div class="flex items-center px-[18px] h-[58px]">
            ...
            <button class="lg:hidden flex items-center bg-transparent border-none cursor-pointer text-white text-[1.4rem] ml-auto p-[6px] transition-all duration-300 hover:text-light-blue hover:scale-110">
